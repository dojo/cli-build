...
describe('css-module-decorator-loader', () => {
	...
	it('should wrap local exports with decorator', () => {
		...
		assert.equal(result, 'exports.locals = {"default":{"classes":{"hello":"world"},"path":"testFile"}};');
	});
	...
	it('should wrap multi line local exports with decorator', () => {
		...
		const result = loader.bind({ resourcePath: 'testFile.css' })(content);
		assert.equal(result, 'exports.locals = {"default":{"classes":{"hello":"world","foo":"bar"},"path":"testFile"}};');
	});
});
